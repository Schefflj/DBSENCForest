...
class Dataset4Generator:
    ...
    def get_dataframe(self):
        ...
        X1, y1 = make_blobs(n_samples=100, centers=[[1, 4]], cluster_std=[0.5], random_state=random_state)
        X2, y2 = make_blobs(n_samples=100, centers=[[6, 6]], cluster_std=[0.5], random_state=random_state)
